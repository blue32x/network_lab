...
#define DRV_VERSION "3.1.0.2" DRV_EXTRAVERSION
...
int debug1 = 0;
int npackets = 1;
int a1[60]={2000,2600,3200,3600,4000,4400,4800,5100,5400,5700,5900,6200,6400,6700,6900,7100,7400,7600,7800,8000,8200,8400,8500,8700,8900,9100,9300,9400,9600,9700,9900,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000};
int a2[60]={1400,1900,2200,2600,2900,3100,3400,3600,3800,4000,4200,4400,4600,4700,4900,5000,5200,5400,5500,5600,5800,5900,6000,6200,6300,6400,6500,6700,6800,6900,7000,7100,7200,7300,7400,7500,7600,7800,7900,8000,8000,8100,8200,8300,8400,8500,8600,8700,8800,8900,9000,9100,9100,9200,9300,9400,9500,9600,9600,9700};
int a3[60]={1100,1500,1800,2100,2300,2600,2800,2900,3100,3300,3400,3600,3700,3900,4000,4100,4200,4400,4500,4600,4700,4800,4900,5000,5100,5200,5300,5400,5500,5600,5700,5800,5900,6000,6100,6200,6200,6300,6400,6500,6600,6700,6700,6800,6900,7000,7000,7100,7200,7300,7300,7400,7500,7500,7600,7700,7700,7800,7900,7900};
int a4[60]={1000,1300,1600,1800,2000,2200,2400,2500,2700,2800,3000,3100,3200,3300,3500,3600,3700,3800,3900,4000,4100,4200,4300,4400,4500,4500,4600,4700,4800,4900,5000,5000,5100,5200,5300,5300,5400,5500,5600,5600,5700,5800,5800,5900,6000,6000,6100,6200,6200,6300,6400,6500,6600,6800,6900,7000,7100,7200,7400,7500};
int a5[60]={900,1200,1400,1600,1800,2000,2100,2300,2400,2500,2700,2800,2900,3000,3100,3200,3300,3400,3500,3600,3700,3700,3800,3900,4000,4100,4100,4200,4300,4400,4400,4500,4600,4600,4700,4800,4800,4900,5000,5100,5200,5300,5400,5600,5700,5800,5900,6000,6200,6300,6400,6500,6600,6800,6900,7000,7100,7200,7400,7500};
int a6[60]={800,1100,1300,1500,1700,1800,1900,2100,2200,2300,2400,2500,2600,2700,2800,2900,3000,3100,3200,3300,3300,3400,3500,3600,3600,3700,3800,3800,3900,4000,4000,4100,4200,4400,4500,4600,4700,4800,5000,5100,5200,5300,5400,5600,5700,5800,5900,6000,6200,6300,6400,6500,6600,6800,6900,7000,7100,7200,7400,7500};
int a7[60]={700,1000,1200,1400,1500,1700,1800,1900,2000,2100,2200,2300,2400,2500,2600,2700,2800,2900,2900,3000,3100,3200,3200,3300,3400,3400,3500,3600,3800,3900,4000,4100,4200,4400,4500,4600,4700,4800,5000,5100,5200,5300,5400,5600,5700,5800,5900,6000,6200,6300,6400,6500,6600,6800,6900,7000,7100,7200,7400,7500};
int a8[60]={700,900,1100,1300,1400,1600,1700,1800,1900,2000,2100,2200,2300,2400,2400,2500,2600,2700,2700,2800,2900,3000,3000,3200,3300,3400,3500,3600,3800,3900,4000,4100,4200,4400,4500,4600,4700,4800,5000,5100,5200,5300,5400,5600,5700,5800,5900,6000,6200,6300,6400,6500,6600,6800,6900,7000,7100,7200,7400,7500};
int a9[60]={700,900,1100,1200,1400,1500,1600,1700,1800,1900,2000,2100,2100,2200,2300,2400,2500,2500,2600,2700,2800,2900,3000,3200,3300,3400,3500,3600,3800,3900,4000,4100,4200,4400,4500,4600,4700,4800,5000,5100,5200,5300,5400,5600,5700,5800,5900,6000,6200,6300,6400,6500,6600,6800,6900,7000,7100,7200,7400,7500};
int a10[60]={600,800,1000,1200,1300,1400,1500,1600,1700,1800,1900,2000,2000,2100,2200,2300,2300,2400,2600,2700,2800,2900,3000,3200,3300,3400,3500,3600,3800,3900,4000,4100,4200,4400,4500,4600,4700,4800,5000,5100,5200,5300,5400,5600,5700,5800,5900,6000,6200,6300,6400,6500,6600,6800,6900,7000,7100,7200,7400,7500};
...
struct socket *s=NULL;						/* Raw socket */
static int send_pause(int pause_time)
{
	...
	if(s==NULL)
	{
	if ((errno  = sock_create(AF_INET, SOCK_PACKET, SOCK_PACKET, &s)) < 0) {
		if (errno == EPERM)
			printk("flow-ctrl must run as root\n");
		else
			printk("flow-ctrl: socket");
		if ( !debug1)
			return 2;
	}
	}
	/* Don't revert if debugging allows a normal user to get the raw socket. */
	pktsize = get_fill(outpack, "01:80:c2:00:00:01", pause_time);
	...
	if (! opt_no_src_addr){
		...
		hwaddr[4]=0x7d;
		hwaddr[5]=0xbd;
		//if (dev_ioctl(net, SIOCGIFHWADDR, &if_hwaddr) < 0) {
		//	printk("SIOCGIFHWADDR on %s\n", ifname);
		//	return 1;
		//}
		memcpy(outpack+6, if_hwaddr.ifr_hwaddr.sa_data, 6);

		if (verbose) {
			printk("The hardware address (SIOCGIFHWADDR) of %s is type %d  "
	...
	if (verbose > 1) {
		printk("The final packet is: ");
		for (i = 0; i < pktsize; i++)
			printk(" %2.2x", outpack[i]);
		printk(".\n");
	}

	/* This is necessary for broadcasts to work */
	if (kernel_setsockopt(s, SOL_SOCKET, SO_BROADCAST, (char *)&one, sizeof(one)) < 0)
		printk("setsockopt: SO_BROADCAST");

	whereto.sa_family = 0;
	strcpy(whereto.sa_data, ifname);

	ksocket_send(s, &whereto, outpack, pktsize);
	return 0;
}
...
static int get_fill(unsigned char *pkt, char *arg, int pause_time)
{
	...
	for (i = 0; i < 6; i++)
		station_addr[i] = sa[i];
	if (debug1)
		printk("Command line stations address is "
				"%2.2x:%2.2x:%2.2x:%2.2x:%2.2x:%2.2x.\n",
				sa[0], sa[1], sa[2], sa[3], sa[4], sa[5]);
...
*/
static bool e1000_clean_tx_irq(struct e1000_ring *tx_ring)// tx : transmit x   rx : receive 
{
	struct e1000_adapter *adapter = tx_ring->adapter;
	struct net_device *netdev = adapter->netdev;
	struct e1000_hw *hw = &adapter->hw;
	...
	eop_desc = E1000_TX_DESC(*tx_ring, eop); //Transmit Descriptor

	//cpu_to_le32 cpu to little endian 
	//E1000_TXD_STAT_DD 0x00000001
...
#define TX_WAKE_THRESHOLD 32
	...
	//printk("total packet: %u\n", total_tx_packets);
	adapter->total_tx_bytes += total_tx_bytes;
	adapter->total_tx_packets += total_tx_packets;

	//send_pause( 1.0 / adapter->itr_setting * 100000000.0/512.0+1);
	//send_pause( 1.0);
	//hw->fc.pause_time = 0x00ff;
	//ew32(FCTTV, hw->fc.pause_time);
	//hw->fc.high_water = 0x0010;
	//hw->fc.low_water = 0xffff;

	//e1000e_set_fc_watermarks(hw);
	//if (!e1000e_has_link(adapter)) {
	//	printk("suspend\n");
	//	pm_schedule_suspend(netdev->dev.parent, 10000);
	//}
	/*
	if(!e1000e_force_mac_fc(hw))
        {
                printk("force\n");
        hw->fc.pause_time = ct;
        ct++;
	...
	*/
	...
	//printk("xoffrxc: %u\n", er32(XOFFRXC));
/*
	if(total_tx_packets == adapter->max_count)
	{
	}
	else if(total_tx_packets < adapter->max_count)
        {      
		if((1000000 / adapter->itr_setting) + 100 >= 10000)
		{
			adapter->itr = (1000000 / 10000);
		}
		else
		{
			adapter->itr = (1000000 / ((1000000 / adapter->itr_setting) + 100));
		}
		adapter->itr_setting = adapter->itr & ~3;
                e1000e_write_itr(adapter, adapter->itr);
		if(adapter->max_count != 0)
			adapter->max_count--;
        }
	else if(total_tx_packets > adapter->max_count)
        {       
		if((1000000 / adapter->itr_setting) - 100 <= 100)
		{
			adapter->itr = (1000000 / 100);
		}
		else
		{
			adapter->itr = (1000000 / ((1000000 / adapter->itr_setting) - 100));
	...
	//if(adapter->max_count>30)//max 30
	//	adapter->max_count = 30;
*/
	if(set_log==10)
		printk("total tx packet: %u bytes: %u itr: %u itr_setting: %u\n", adapter->total_tx_packets, adapter->total_tx_bytes, adapter->itr, adapter->itr_setting);
#ifdef HAVE_NDO_GET_STATS64
#elif defined(HAVE_NETDEV_STATS_IN_NETDEV)
	netdev->stats.tx_bytes += total_tx_bytes;
	netdev->stats.tx_packets += total_tx_packets;
	printk("total tx packet1: %u\n", netdev->stats.tx_packets);
#else
	adapter->net_stats.tx_bytes += total_tx_bytes;
	adapter->net_stats.tx_packets += total_tx_packets;
	printk("total tx packet2: %u\n", adapter->net_stats.tx_packets);
#endif
